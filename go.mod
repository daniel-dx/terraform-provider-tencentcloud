...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/tcb v1.0.1131 // indirect
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/tcbr v1.0.1115 // indirect
